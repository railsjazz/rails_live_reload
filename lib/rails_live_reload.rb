...
require "rails_live_reload/connection"
...
require "rails_live_reload/rails/middleware/websocket"
...
module RailsLiveReload
  ...
  def self.middleware
    ...
    when :websocket then RailsLiveReload::Rails::Middleware::Websocket
    end
  end
end
